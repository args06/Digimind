...
struct Dashboard: View {
    ...
    @State var consumedCalorie: Int = 2140
            ...
            VStack {
                ...
                HStack(alignment: .top) {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        ProgressBar(width: 128, height: 4, percent: ((day/7) * 100))
                ...
                Text("\(consumedCalorie) kCal")
                    ...
                    .shadow(color: Color("RaisinBlack"), radius: 5, y: 3)
                    .padding(.top, 24)
                
                Text("86% of your daily calories (\(totalCalorie) kCal)")
                    .font(.callout)
                    .fontWeight(.bold)
                    .foregroundColor(.white)
